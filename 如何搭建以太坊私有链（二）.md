...
以太坊支持**自定义创世区块**，要运行私有链，我们就需要定义自己的创世区块，创世区块信息写在一个json格式的配置文件中。首先将下面的内容保存到一个json文件中，例如genesis.json。
...
![1554280849969](/home/hahaha/笔记/区块链/如何搭建以太坊私有链.assets/1554280849969.png)
...
![1554280889237](/home/hahaha/笔记/区块链/如何搭建以太坊私有链.assets/1554280889237.png)
...
![1554280995657](/home/hahaha/笔记/区块链/如何搭建以太坊私有链.assets/1554280995657.png)
...
Passphrase其实就是密码的意思，输入两次密码后，就创建了一个账户。再次执行命令创建一个账户
...
![1554281115853](/home/hahaha/笔记/区块链/如何搭建以太坊私有链.assets/1554281115853.png)
...
这里报错了，原因是账户每隔一段时间就会被锁住，要发送交易，必须先解锁账户，由于我们要从账户0发送交易，所以要解锁账户0（输入密码）：
